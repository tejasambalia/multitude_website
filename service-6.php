            ...
            <div class="col-lg-3 col-md-4 col-sm-12">
                <div class="service-sidebar">
                    <ul class="service-catergory">
                        ...
                        <li class="active"><a href="service-6.php">Customer Insights</a></li>
                    ...
                    <div class="brochures">
                        ...
                        <ul class="brochures-lists">
                            ...
                            <li><a href="3/index.php"><span class="fa fa-file-word-o"></span>Financial Report.DOC</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                <div class="outer-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="img-box"><a href="#"><img src="images/service/11.jpg" alt=""></a></div>
                        </div>
                    </div><br><br>
