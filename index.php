        ...
        <ul>
            ...
            <li data-transition="fade">
                ...
                <div class="tp-caption tp-resizeme" 
                    ...
                    <div class="slide-content-box">
                        <div class="button">
                            <a class="thm-btn-tr" href="testimonials.php">Testimonials</a>     
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="single-project">
                    <figure class="imghvr-shutter-in-out-horiz">
                        ...
                        <figcaption>
                            <div class="content">
                                <a href="project-single.php"><h4>Latest Technology</h4></a>
                                <p>Consulting</p>
                            </div> 
                        </figcaption>
                    </figure>
            ...
            <div class="item">
                <div class="single-latest-project-carousel">
                    ...
                    <figure class="imghvr-shutter-in-out-horiz">
                        ...
                        <figcaption>
                            <div class="content">
                                <a href="project-single.php"><h4>Audit & Assurance</h4></a>
                                <p>Financial</p>
                            </div>    
                        </figcaption>
                    </figure>
            ...
            <div class="item">
                <div class="single-latest-project-carousel">
                    ...
                    <figure class="imghvr-shutter-in-out-horiz">
                        ...
                        <figcaption>
                            <div class="content">
                                <a href="project-single.php"><h4>Business Growth</h4></a>
                                <p>Growth</p>
                            </div> 
                        </figcaption>
                    </figure>
            ...
            <div class="item">
                <div class="single-latest-project-carousel">
                    ...
                    <figure class="imghvr-shutter-in-out-horiz">
                        ...
                        <figcaption>
                            <div class="content">
                                <a href="project-single.php"><h4>Transporation Service</h4></a>
                                <p>Marketing</p>
                            </div> 
                        </figcaption>
                    </figure>
                ...
                <div class="default-blog-news wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    <figure class="img-holder">
                        ...
                        <figcaption class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="blog-details.php"><i class="fa fa-link" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </figcaption>
                    </figure>
                    <div class="lower-content">
                        ...
                        <div class="link">
                            <a href="blog-details.php" class="default_link">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="default-blog-news wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div class="lower-content">
                        ...
                        <h4><a href="blog-details.php">Improve your business growth</a></h4>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="default-blog-news wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div class="lower-content">
                        ...
                        <h4><a href="blog-details.php">Save money for your future.</a></h4>
